<template>
  <div class="fixed inset-0 overflow-hidden z-40 pt-20 pointer-events-none">
    <transition-group name="fade">
      <div v-for="toast in toasts" :key="toast._id" class="pointer-events-auto mx-auto md:ml-5 md:mr-auto mt-5 block w-25 max-w-300 bg-white h-24 border rounded shadow-xl">
